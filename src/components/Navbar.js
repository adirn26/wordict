...
export default function Navbar() {
  ...
  const navigation = [
    { name: 'Add Word', href: '#', current: false, onClick: () => { setOpen(true) } },
  ]
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
              <div className="relative flex h-16 items-center justify-between">
                ...
                <div className="flex-shrink-0">
                  <h1 className="text-3xl font-medium text-white">Wordict</h1>
                </div>
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="relative mt-2 rounded-md shadow-sm">
                          <textarea
                            name="price"
                            id="price"
                            class="block w-full rounded-md py-1.5 pl-3 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 resize vertical"
